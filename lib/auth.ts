...
export const { handlers, auth, signIn, signOut } = NextAuth({
  ...
  // Next.js removes its public basePath (/academy) before the route reaches
  // Auth.js. Keep the Auth.js route internal; the client SessionProvider uses
  // the public /academy/api/auth endpoint separately.
  basePath: "/api/auth",
  pages: { signIn: "/login" },
  trustHost: true,
  providers: [
