      ...
      <section className={scope.isSacfAdmin ? "split" : undefined}>
        ...
        {scope.isSacfAdmin ? (
          <form className="detailPanel" action={createOrganization}>
            ...
            <label>{t.slugLabel}<small>{t.slugHint}</small><input className="field" name="slug" placeholder={t.slugPlaceholder} /></label>
            <label>{t.adminEmailLabel}<input className="field" name="adminEmail" type="email" placeholder={t.adminEmailPlaceholder} /></label>
            <label>{t.seatLimitLabel} <small>{t.seatLimitInputHint}</small><input className="field" name="seatLimit" type="number" min={1} step={1} placeholder={t.seatLimitPlaceholder} /></label>
